...
/**
 * Servlet implementation class M_certifiedEmail
 */
@WebServlet("/main/certifiedEmail.do")
public class M_certifiedEmail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public M_certifiedEmail() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result = mService.emailCheck(email);
