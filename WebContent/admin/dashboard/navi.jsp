      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="/admin/dashboard/pages/BusinessManage.jsp">
            ...
            <span class="nav-link-text ms-1">Business Manage</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="/admin/dashboard/pages/noticeBoard.jsp">
            ...
            <span class="nav-link-text ms-1">NoticeBoard</span>    <!--21/12/12 디자인 바꿀것 -->
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="/admin/dashboard/pages/virtual-reality.jsp">
            ...
            <span class="nav-link-text ms-1">2NoticeBoard2</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="/admin/dashboard/pages/notifications.jsp">
            ...
            <span class="nav-link-text ms-1">noticeBoard or QnA Alerts</span>
          </a>
        </li>
