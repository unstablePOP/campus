...
<%-- 이용 약관 부분 --%>
			<div class="termsWrap">
				<div class="checkWrap">
					<label><input type="checkbox" class="termsCheck"
						id="useTerms"> 이용약관 동의 <span style="color: blue">(필수)</span></label>
				</div>
...
<%-- 개인 정보 약관 부분 --%>
			<div class="termsWrap">
				<div class="checkWrap">
					<label><input type="checkbox" class="termsCheck"
						id="inforTerms"> 개인정보수집·이용 내역 동의 <span style="color: blue">(필수)</span></label>
				</div>
				<div class="termsTextWrap">
					<textarea class="termsText" disabled=true>
제1장 수집항목
...
<%-- 전체 체크 박스 --%>
			<div id="allCheckWrap">
				<label><input type="checkbox" id="allCheck">모두
					동의합니다.</label>
			</div>
			<br>
<%-- 다음 단계 button 부분 --%>
	...
	<script>
		$("#nextStepBtn").click(function(){
			if(!$("#allCheck").is(':checked')){
				...
				location.replace('/main/join/joinCertified.jsp')
			}
		});
