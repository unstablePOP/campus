                ...
                <div id="idInforInputWrap">
                    ...
                    <dl>
                        ...
                        <dd class="firstDt">
                            ...
                            <div class="inputDescription">영문, 숫자만 가능합니다. (5~15자)</div>
                        </dd>
                    </dl>
                    <dl>
                        <dt><span class="stars">*</span> 비밀번호</dt>
                        <dd>
                            <div class="inputTextWrap"><input type="password" class="inputText" placeholder="(8~15글자)영어 대소문자 + 숫자 + 특수문자로 구성되어야 합니다."></div>
...
<%-- 개인 정보 input 부분 --%>
                <div id="userInforInputWrap">
                    ...
                    <dl>
                        ...
                        <dd class="firstDt">
                            <div class="inputTextWrap"><input type="text" class="inputText" placeholder=""></div>
                            <div class="inputBtnWrap"><button class="inputBtn">중복 확인</button></div>
