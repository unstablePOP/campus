    ...
    <div id="wrap">
        ...
        <div id="bodyWrap">
            ...
            <div id="ContentWrap">
                <h3>문의하기</h3>
                <%-- 문의 폼 시작 --%>
                <form id="question-form" action="/main/serviceQna.do" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <%-- 제목 입력란 --%>
                        <div class="input-group">
                            <input type="text" id="serviceSubject" name="serviceSubject">
                        </div>
                    </div>
                    <div id="form-text">
                        <div class="infor-group">
                        ...
                        <%-- 내용 입력란 --%>
                        <div class="input-group">
                            <textarea name="serviceContent" id="serviceContent" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <br>
                    <br>
                    ...
                    <br>
                    <div id="checkBtnWrap">
                        <input type="submit" value="문의하기" id="checkSubmit">
                        <input type="reset" value="취소" id="checkReset">
                    </div>
                </form>
            </div>
        </div>
